                      ...
                      return (
                        <div
                          ...
                          className={`
                                                            ...
                                                            rounded-lg transition-all duration-200 cursor-pointer relative group m-1
                                                            ${
                                                              !day.isCurrentMonth
                            ...
                            <>
                              {isEventStart && (
                                <div className="absolute -top-1 -right-1 z-10">
                                  <div className="md:hidden w-2.5 h-2.5 bg-green-500 rounded-full shadow-md" />
                                  <div className="hidden md:block  bg-green-500 text-white px-1.5 py-0.5 rounded-md text-[9px] font-bold shadow-md">
                                    START
                                  </div>
                                </div>
                              )}
                              {isEventEnd && (
                                <div className="absolute -top-1 -right-1 z-10">
                                  <div className="md:hidden w-2.5 h-2.5 bg-red-500 rounded-full shadow-md" />
                                  <div className="hidden md:block  bg-red-500 text-white px-1.5 py-0.5 rounded-md text-[9px] font-bold shadow-md">
                                    END
                                  </div>
                                </div>
                              )}
                    ...
                    {schedules.map((schedule, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {(schedule.company_name || schedule.company) && (
                          ...
                          {/* <div className="flex flex-wrap gap-2 mt-2">
                            <span className="px-2 py-0.5 text-xs bg-blue-100-700 rounded">
                              {schedule.enroll_type_name}
                            </span>
                            <span className="px-2 py-0.5 text-xs bg-green-100-700 rounded">
                              {schedule.course_status_name}
                            </span>
                          </div> */}
                          ...
                          <div className="mt-3 space-y-1 text-xs">
                            <div className="flex items-center gap-2">
                              <Clock className="w-3 h-3" />
                              Start: {formatScheduleDate(schedule.date)}
                            </div>
                            <div className="flex items-center gap-2">
                              <Clock className="w-3 h-3" />
                              End: {formatScheduleDate(schedule.end_date)}
                            </div>
                          </div>
