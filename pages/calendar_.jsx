                        ...
                        >
                          ...
                          <div className="mt-3 space-y-1 text-xs text-gray-600">
                            <div className="flex items-center gap-2">
                              ...
                              Start: {formatScheduleDate(schedule.publish_date)}
                            </div>
                            <div className="flex items-center gap-2">
                              <Clock className="w-3 h-3" />
                        ...
                        (schedule, index) => {
                          ...
                          return (
                            <div
                              ...
                              className="relative bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-5 text-white shadow-lg hover:shadow-xl transition-all hover:scale-[1.02]"
                            >
                              {isUrgent && (
                                <div className="absolute top-3 right-3">
                                  <div className="bg-yellow-400 text-yellow-900 px-3 py-1.5 rounded-lg text-xs font-bold flex items-center gap-1 animate-pulse">
                                    <Clock className="w-3 h-3" />
                              ...
                              <div className="flex items-start justify-between mb-4">
                                ...
                                <span className="px-3 py-1 bg-green-400 text-green-900 rounded-lg text-xs font-bold">
                                  Online
                                </span>
                              </div>
                              ...
                              <div className="grid grid-cols-2 gap-3 bg-white/10 rounded-lg p-3">
                                <div>
                                  <p className="text-xs text-blue-100">Start</p>
                                  <p className="font-semibold">
                                    {formatScheduleDate(schedule.publish_date)}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-xs text-blue-100">End</p>
                                  <p className="font-semibold">
                ...
                {schedules.length > 2 && (
                  <div className="mt-6 flex items-center justify-between">
                    ...
                    <button
                      onClick={() =>
                        setSchedulePage((p) =>
                          Math.min(getTotalPages(schedules, 2), p + 1)
                        )
                      }
