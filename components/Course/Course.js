...
export default function Course({ courses, onAddContent,onSave }) {
    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow">
            ...
            {courses.map((course) => (
                <div key={course.id_course} className="border-b bg-slate-100 rounded-lg border-slate-200">
                    {/* Main Course Row */}
                    <div className="flex items-center justify-between py-4 px-6 hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center space-x-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-sm text-gray-700">{course.publish_date ? "Published" : "Unpublished"}</span>
                            </div>
                            <button
                    ...
                    <div className="bg-white rounded-lg">
                        ...
                        <div
                            ...
                            className="flex items-center rounded-lg justify-between py-2 px-6 border-l-2 border-slate-300 hover:bg-white transition-colors"
                        >
                            <div className="flex items-center space-x-4">
            ...
            {isModalOpen && (
                <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center" >
                    <div className="rounded-lg border border-gray-200 bg-white shadow-xl w-full max-w-4xl">
                        {/* Header */}
